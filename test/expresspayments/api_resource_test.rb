  ...
  class ApiResourceTest < Test::Unit::TestCase
    ...
    context ".custom_method" do
      should "call to an RPC-style method" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/custom_methods/ch_123/my_method")
      ...
      should "raise an error if an unsupported target is passed" do
        e = assert_raises ArgumentError do
          ExpressPayments::Util.custom_method(CustomMethodAPIResource, String, :my_method, :post, "/")
        end
    ...
    should "creating a new APIResource should not fetch over the network" do
      ExpressPayments::Customer.new("someid")
      assert_not_requested :get, %r{#{ExpressPayments.api_base}/.*}
    end

    should "creating a new APIResource from a hash should not fetch over the network" do
      ExpressPayments::Customer.construct_from(id: "somecustomer",
    ...
    should "setting an attribute should not cause a network request" do
      c = ExpressPayments::Customer.new("cus_123")
      c.card = { id: "somecard", object: "card" }
      assert_not_requested :get, %r{#{ExpressPayments.api_base}/.*}
      assert_not_requested :post, %r{#{ExpressPayments.api_base}/.*}
    end
    ...
    should "not specifying api credentials should raise an exception" do
      ...
      assert_raises ExpressPayments::AuthenticationError do
        ExpressPayments::Customer.new("cus_123").refresh
      end
    end

    should "using a nil api key should raise an exception" do
      assert_raises TypeError do
        ExpressPayments::Customer.list({}, nil)
      end
      assert_raises TypeError do
        ExpressPayments::Customer.list({}, api_key: nil)
      end
    end

    should "specifying api credentials containing whitespace should raise an exception" do
      ExpressPayments.api_key = "key "
      assert_raises ExpressPayments::AuthenticationError do
        ExpressPayments::Customer.new("cus_123").refresh
      end
    end
    ...
    should "send expand on fetch properly" do
      ...
      ExpressPayments::Charge.retrieve(id: "ch_123", expand: [:customer])
    end
    ...
    should "preserve expand across refreshes" do
      ...
      ch = ExpressPayments::Charge.retrieve(id: "ch_123", expand: [:customer])
      ch.refresh
    end
    ...
    should "send expand when fetching through ListObject" do
      ...
      stub_request(:get, "#{ExpressPayments.api_base}/v1/charges/ch_123/refunds/re_123")
        .with(query: { "expand" => ["balance_transaction"] })
        .to_return(body: JSON.generate(charge_fixture))

      charge = ExpressPayments::Charge.retrieve("ch_123")
    ...
    context "when specifying per-object credentials" do
      context "with no global API key set" do
        should "use the per-object credential when creating" do
          ...
          ExpressPayments::Charge.create({ source: "tok_visa" },
                                         "sk_test_local")
        end
      end
      ...
      context "with a global API key set" do
        setup do
          ExpressPayments.api_key = "global"
        end
        ...
        should "use the per-object credential when retrieving and making other calls" do
          stub_request(:get, "#{ExpressPayments.api_base}/v1/charges/ch_123")
            .with(headers: { "Authorization" => "Bearer sk_test_local" })
            .to_return(body: JSON.generate(charge_fixture))
          stub_request(:post, "#{ExpressPayments.api_base}/v1/charges/ch_123/refunds")
            .with(headers: { "Authorization" => "Bearer sk_test_local" })
            .to_return(body: "{}")

          ch = ExpressPayments::Charge.retrieve("ch_123", "sk_test_local")
          ch.refunds.create
        end
      end
    end
    ...
    context "with valid credentials" do
      should "urlencode values in GET params" do
        ...
        charges = ExpressPayments::Charge.list(customer: "test customer").data
      ...
      should "construct URL properly with base query parameters" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/charges")
          ...
          .to_return(body: JSON.generate(data: [charge_fixture],
                                         url: "/v1/charges",
                                         object: "list"))
        charges = ExpressPayments::Charge.list(customer: "cus_123")
      ...
      should "setting a nil value for a param should exclude that param from the request" do
        ...
        ExpressPayments::Charge.list(count: nil, offset: 5, sad: false)

        stub_request(:post, "#{ExpressPayments.api_base}/v1/charges")
          .with(body: { "amount" => "50", "currency" => "usd" })
          .to_return(body: JSON.generate(count: 1, data: [charge_fixture]))
        ExpressPayments::Charge.create(amount: 50, currency: "usd", card: { number: nil })
      end
      ...
      should "not trigger a warning if a known opt, such as idempotency_key, is in opts" do
        ...
        $stderr = StringIO.new
        begin
          ExpressPayments::Charge.create({ amount: 100, currency: "usd", card: "sc_token" }, idempotency_key: "12345")
      ...
      should "error if the params is not a Hash" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/charges/ch_123/capture")
          .to_return(body: JSON.generate(charge_fixture))

        e = assert_raises(ArgumentError) { ExpressPayments::Charge.capture("ch_123", "sk_test_secret") }
      ...
      should "allow making a request with params set to nil" do
        ...
        ExpressPayments::Charge.capture("ch_123", nil, "sk_test_secret")
      end
      ...
      should "error if a user-specified opt is given a non-nil non-string value" do
        ...
        ExpressPayments::Charge.create({ amount: 100, currency: "usd" }, {})
        ExpressPayments::Charge.create({ amount: 100, currency: "usd" }, idempotency_key: "12345")

        # Errors on a non-string.
        e = assert_raises(ArgumentError) do
          ExpressPayments::Charge.create({ amount: 100, currency: "usd" }, idempotency_key: :foo)
        end
      ...
      should "requesting with a unicode ID should result in a request" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/customers/%E2%98%83")
          .to_return(body: JSON.generate(make_missing_id_error), status: 404)
        c = ExpressPayments::Customer.new("☃")
        assert_raises(ExpressPayments::InvalidRequestError) { c.refresh }
      end
      ...
      should "making a GET request with parameters should have a query string and no body" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/charges")
          .with(query: { limit: 1 })
          .to_return(body: JSON.generate(data: [charge_fixture]))
        ExpressPayments::Charge.list(limit: 1)
      end
      ...
      should "making a POST request with parameters should have a body and no query string" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/charges")
          ...
          .to_return(body: JSON.generate(charge_fixture))
        ExpressPayments::Charge.create(amount: 100, currency: "usd", card: "sc_token")
      end

      should "loading an object should issue a GET request" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/charges/ch_123")
          .to_return(body: JSON.generate(charge_fixture))
        c = ExpressPayments::Charge.new("ch_123")
        c.refresh
      end
      ...
      should "using array accessors should be the same as the method interface" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/charges/ch_123")
          .to_return(body: JSON.generate(charge_fixture))
        c = ExpressPayments::Charge.new("cus_123")
        c.refresh
      ...
      should "saving an object should issue a POST request with only the changed properties" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/customers/cus_123")
          .with(body: { "description" => "another_mn" })
          .to_return(body: JSON.generate(customer_fixture))
        c = ExpressPayments::Customer.construct_from(customer_fixture)
      ...
      should "updating an object should issue a POST request with the specified properties" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/customers/cus_123")
          .with(body: { "description" => "another_mn" })
          .to_return(body: JSON.generate(customer_fixture))
        ExpressPayments::Customer.construct_from(customer_fixture)
        ExpressPayments::Customer.update("cus_123", { description: "another_mn" })
      end
      ...
      should "updating should fail if api_key is nil" do
        ExpressPayments::Customer.new("cus_123")
        assert_raises TypeError do
          ExpressPayments::Customer.update("cus_123", {}, { api_key: nil })
        end
      end

      should "saving should use the supplied api_key" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/customers")
          .with(headers: { "Authorization" => "Bearer sk_test_local" })
          .to_return(body: JSON.generate(customer_fixture))
        c = ExpressPayments::Customer.new
      ...
      should "updating should use the supplied api_key" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/customers")
          ...
          .to_return(body: JSON.generate(customer_fixture))
        ExpressPayments::Customer.new("cus_123")
        ExpressPayments::Customer.update("cus_123", {}, api_key: "sk_test_local")
      end

      should "deleting should send no props and result in an object that has no props other deleted" do
        stub_request(:delete, "#{ExpressPayments.api_base}/v1/customers/cus_123")
      ...
      should "loading all of an APIResource should return an array of recursively instantiated objects" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/charges")
          .to_return(body: JSON.generate(data: [charge_fixture]))
        charges = ExpressPayments::Charge.list.data
        assert charges.is_a? Array
        assert charges[0].is_a? ExpressPayments::Charge
        assert charges[0].payment_method_details.is_a?(ExpressPayments::ExpressPaymentsObject)
      end

      should "passing in a ep_account header should pass it through on call" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/customers/cus_123")
          .with(headers: { "EP-Account" => "acct_123" })
          .to_return(body: JSON.generate(customer_fixture))
        ExpressPayments::Customer.retrieve("cus_123", ep_account: "acct_123")
      end

      should "passing in a ep_account header should pass it through on save" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/customers/cus_123")
          .with(headers: { "EP-Account" => "acct_123" })
          .to_return(body: JSON.generate(customer_fixture))
        c = ExpressPayments::Customer.retrieve("cus_123", ep_account: "acct_123")
      ...
      should "add key to nested objects on save" do
        acct = ExpressPayments::Account.construct_from(id: "myid",
                                                       legal_entity: {
                                                size: "l",
                                                score: 4,
                                                height: 10,
        ...
        stub_request(:post, "#{ExpressPayments.api_base}/v1/accounts/myid")
      ...
      should "update with a nested object" do
        ...
        ExpressPayments::Account.update("myid", { business_profile: { name: "Bob" } })
      end

      should "save nothing if nothing changes" do
        acct = ExpressPayments::Account.construct_from(id: "acct_id",
                                                       metadata: {
                                                key: "value",
                                              })

        stub_request(:post, "#{ExpressPayments.api_base}/v1/accounts/acct_id")
          .with(body: {})
      ...
      should "not save nested API resources" do
        ch = ExpressPayments::Charge.construct_from(id: "ch_id",
                                                    customer: {
                                             object: "customer",
                                             id: "customer_id",
                                           })

        stub_request(:post, "#{ExpressPayments.api_base}/v1/charges/ch_id")
          .with(body: {})
      ...
      should "correctly handle replaced nested objects on save" do
        acct = ExpressPayments::Account.construct_from(
          id: "acct_123",
          company: {
            name: "company_name",
            address: {
        ...
        stub_request(:post, "#{ExpressPayments.api_base}/v1/accounts/acct_123")
      ...
      should "correctly handle array insertion on save" do
        ...
        # data decoding, which isn't aware of the ExpressPayments array encoding that we
        # use here.
        stub_request(:post, "#{ExpressPayments.api_base}/v1/accounts/myid")
          .with(body: { legal_entity: { additional_owners: [{ first_name: "Bob" }] } })
          .to_return(body: JSON.generate("id" => "myid"))
      ...
      should "should create a new resource when an object without an id is saved" do
        account = ExpressPayments::Account.construct_from(id: nil,
                                                          display_name: nil)

        stub_request(:post, "#{ExpressPayments.api_base}/v1/accounts")
          .with(body: { display_name: "expresspayments" })
          .to_return(body: JSON.generate("id" => "acct_123"))

        account.display_name = "expresspayments"
        account.save
      end
      ...
      should "set attributes as part of save" do
        ...
        stub_request(:post, "#{ExpressPayments.api_base}/v1/accounts")
          .with(body: { display_name: "expresspayments", metadata: { key: "value" } })
          .to_return(body: JSON.generate("id" => "acct_123"))

        account.save(display_name: "expresspayments", metadata: { key: "value" })
      end
    end

    context "#request_expresspayments_object" do
      ...
      setup do
        Util.instance_variable_set(
          :@object_classes,
          ExpressPayments::ObjectTypes.object_names_to_classes.merge(
            "hello" => HelloTestAPIResource
          )
        )
      end
      teardown do
        Util.class.instance_variable_set(:@object_classes, ExpressPayments::ObjectTypes.object_names_to_classes)
      end

      should "make requests appropriately" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/hellos/hi_123/say")
          .with(body: { foo: "bar" }, headers: { "EP-Account" => "acct_hi" })
          .to_return(body: JSON.generate("object" => "hello"))

        hello = HelloTestAPIResource.new(id: "hi_123")
        hello.say_hello({ foo: "bar" }, ep_account: "acct_hi")
      end
    ...
    context "#request_stream" do
      ...
      should "supports requesting with a block" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/streams/hi_123/read")
          .with(query: { foo: "bar" }, headers: { "EP-Account" => "acct_hi" })
          .to_return(body: "response body")

        accumulated_body = +""

        resp = StreamTestAPIResource.new(id: "hi_123").read_stream({ foo: "bar" }, ep_account: "acct_hi") do |body_chunk|
      ...
      should "fail when requesting without a block" do
        ...
        assert_raises ArgumentError do
          StreamTestAPIResource.new(id: "hi_123").read_stream({ foo: "bar" }, ep_account: "acct_hi")
        end
      end
    end
    ...
    context "test helpers" do
      ...
      should "make requests appropriately" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/test_helpers/hellos/hi_123/say_hello")
          .with(body: { foo: "bar" }, headers: { "EP-Account" => "acct_hi" })
          .to_return(body: JSON.generate("object" => "hello"))

        hello = TestHelperAPIResource.new(id: "hi_123")
        hello.test_helpers.say_hello({ foo: "bar" }, ep_account: "acct_hi")
      end
      ...
      should "forward opts" do
        ...
        hello = TestHelperAPIResource.new("hi_123", ep_account: "acct_hi")
      ...
      should "return resource" do
        ...
        hello = TestHelperAPIResource.new(id: "hi_123")
        new_hello = hello.test_helpers.say_hello({ foo: "bar" }, ep_account: "acct_hi")
      ...
      should "be callable statically" do
        ...
        new_hello = TestHelperAPIResource::TestHelpers.say_hello("hi_123", { foo: "bar" }, ep_account: "acct_hi")
        assert new_hello.is_a? TestHelperAPIResource
        assert_equal "hi!", new_hello.result
      end
    end
    ...
    # Expects to retrieve a fixture from expresspayments-mock (an API call should be
