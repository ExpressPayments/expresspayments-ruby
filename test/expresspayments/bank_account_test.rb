  ...
  class BankAccountTest < Test::Unit::TestCase
    context "#resource_url" do
      should "return an external account URL" do
        bank_account = ExpressPayments::BankAccount.construct_from(
          account: "acct_123",
          id: "ba_123"
        )
    ...
    context "#verify" do
      should "verify the account" do
        bank_account = ExpressPayments::BankAccount.construct_from(customer: "cus_123",
                                                                   id: "ba_123")
        bank_account = bank_account.verify(amounts: [1, 2])
        assert bank_account.is_a?(ExpressPayments::BankAccount)
      end
    end
  end
end
