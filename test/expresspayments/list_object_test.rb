...
module ExpressPayments
  class ListObjectTest < Test::Unit::TestCase
    should "provide .empty_list" do
      list = ExpressPayments::ListObject.empty_list
      assert list.empty?
    end

    should "provide #count via enumerable" do
      list = ExpressPayments::ListObject.construct_from(data: [{ object: "charge" }])
    ...
    should "provide #each" do
      ...
      list = ExpressPayments::ListObject.construct_from(data: arr)
    ...
    should "provide #reverse_each" do
      ...
      expected = Util.convert_to_expresspayments_object(arr.reverse, {})
      list = ExpressPayments::ListObject.construct_from(data: arr)
    ...
    should "provide #empty?" do
      list = ExpressPayments::ListObject.construct_from(data: [])
      assert list.empty?
      list = ExpressPayments::ListObject.construct_from(data: [{}])
      refute list.empty?
    end
    ...
    should "fetch an empty page through #next_page" do
      list = TestListObject.construct_from(data: [{ id: 1 }],
                                           ...
                                           object: "list")
      next_list = list.next_page
      assert_equal ExpressPayments::ListObject.empty_list, next_list
    end
...
class TestListObject < ExpressPayments::ListObject
end
