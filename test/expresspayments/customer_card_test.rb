...
module ExpressPayments
  class CustomerCardTest < Test::Unit::TestCase
    ...
    should "be creatable" do
      ...
      assert_requested :post, "#{ExpressPayments.api_base}/v1/customers/#{@customer.id}/sources"
    end

    should "be deletable" do
      card = ExpressPayments::Card.construct_from(customer: @customer.id,
                                                  id: "card_123")
      card.delete
      assert_requested :delete, "#{ExpressPayments.api_base}/v1/customers/#{@customer.id}/sources/card_123"
    end
    ...
    should "be saveable" do
      ...
      card.save
      assert_requested :post, "#{ExpressPayments.api_base}/v1/customers/#{@customer.id}/sources/card_123"
    end
  end
end
