  ...
  class ApiOperationsTest < Test::Unit::TestCase
    ...
    context ".update" do
      should "post the correct parameters to the resource URL" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/updateableresources/id")
          .with(body: { foo: "bar" })
    ...
    context ".nested_resource_class_methods" do
      ...
      should "define a create method" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/mainresources/id/nesteds")
          .with(body: { foo: "bar" })
      ...
      should "define a retrieve method" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/mainresources/id/nesteds/nested_id")
          .to_return(body: JSON.generate(id: "nested_id", object: "nested", foo: "bar"))
      ...
      should "define an update method" do
        stub_request(:post, "#{ExpressPayments.api_base}/v1/mainresources/id/nesteds/nested_id")
          .with(body: { foo: "baz" })
      ...
      should "define a delete method" do
        stub_request(:delete, "#{ExpressPayments.api_base}/v1/mainresources/id/nesteds/nested_id")
      ...
      should "define a list method" do
        stub_request(:get, "#{ExpressPayments.api_base}/v1/mainresources/id/nesteds")
