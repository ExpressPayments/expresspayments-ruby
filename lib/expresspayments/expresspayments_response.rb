...
module ExpressPayments
  ...
  class ExpressPaymentsResponseHeaders
  ...
  module ExpressPaymentsResponseBase
    ...
    def self.populate_for_net_http(resp, http_resp)
      resp.http_headers = ExpressPaymentsResponseHeaders.from_net_http(http_resp)
      resp.http_status = http_resp.code.to_i
      resp.request_id = http_resp["request-id"]
    end
  end

  # ExpressPaymentsResponse encapsulates some vitals of a response that came back from
  # the ExpressPayments API.
  class ExpressPaymentsResponse
    include ExpressPaymentsResponseBase
    ...
    # Initializes an ExpressPaymentsResponse object from a Net::HTTP::HTTPResponse
    # object.
    def self.from_net_http(http_resp)
      resp = ExpressPaymentsResponse.new
      resp.data = JSON.parse(http_resp.body, symbolize_names: true)
      resp.http_body = http_resp.body
      ExpressPaymentsResponseBase.populate_for_net_http(resp, http_resp)
      resp
    end
  end

  # We have to alias ExpressPaymentsResponseHeaders to ExpressPaymentsResponse::Headers, as this
  # class used to be embedded within ExpressPaymentsResponse and we want to be backwards
  # compatible.
  ExpressPaymentsResponse::Headers = ExpressPaymentsResponseHeaders

  # ExpressPaymentsHeadersOnlyResponse includes only header-related vitals of the
  ...
  # response in memory.
  class ExpressPaymentsHeadersOnlyResponse
    include ExpressPaymentsResponseBase

    # Initializes an ExpressPaymentsHeadersOnlyResponse object from a
    # Net::HTTP::HTTPResponse object.
    def self.from_net_http(http_resp)
      resp = ExpressPaymentsHeadersOnlyResponse.new
      ExpressPaymentsResponseBase.populate_for_net_http(resp, http_resp)
      resp
    end
  end
