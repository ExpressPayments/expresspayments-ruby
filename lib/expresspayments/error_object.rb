...
module ExpressPayments
  ...
  #
  # @see https://docs.epayments.network/api/errors
  class ErrorObject < ExpressPaymentsObject
  ...
  #
  # @see https://docs.epayments.network/connect/oauth-reference#post-token-errors
  class OAuthErrorObject < ExpressPaymentsObject
