...
module ExpressPayments
  class ListObject < ExpressPaymentsObject
    include Enumerable
    include ExpressPayments::APIOperations::List
    include ExpressPayments::APIOperations::Request
    include ExpressPayments::APIOperations::Create
    ...
    #
    # The default iteration direction is forwards according to ExpressPayments' API
