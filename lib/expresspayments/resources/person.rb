...
module ExpressPayments
  ...
  # See the [Standard onboarding](https://docs.epayments.network/connect/standard-accounts) or [Express onboarding documentation](https://docs.epayments.network/connect/express-accounts) for information about platform prefilling and account onboarding steps.
  #
  # Related guide: [Handling identity verification with the API](https://docs.epayments.network/connect/handling-api-verification#person-information)
