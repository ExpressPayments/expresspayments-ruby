  ...
  class Account < APIResource
    ...
    private def serialize_additional_owners(legal_entity, additional_owners)
      ...
      additional_owners.each_with_index do |v, i|
        # We will almost always see an ExpressPaymentsObject except in the case of a Hash
        ...
        # ExpressPaymentsObjects that can detect appends and replace a hash with a
        # ExpressPaymentsObject.
        update = v.is_a?(ExpressPaymentsObject) ? v.serialize_params : v
