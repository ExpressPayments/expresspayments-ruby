...
module ExpressPayments
  ...
  # [transfer_group](https://docs.epayments.network/connect/separate-charges-and-transfers#transfer-options)
  # transfer only if the destination account has enough balance to cover the
  # reversal.
  #
  # Related guide: [Reversing transfers](https://docs.epayments.network/connect/separate-charges-and-transfers#reversing-transfers)
