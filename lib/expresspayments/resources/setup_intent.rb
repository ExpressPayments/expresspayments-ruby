...
module ExpressPayments
  ...
  # The SetupIntent transitions through multiple [statuses](https://docs.epayments.network/payments/intents#intent-statuses) as it guides
  # you through the setup process.
  #
  # Successful SetupIntents result in payment credentials that are optimized for future payments.
  # For example, cardholders in [certain regions](https://epayments.network/guides/strong-customer-authentication) might need to be run through
  # [Strong Customer Authentication](https://docs.epayments.network/strong-customer-authentication) during payment method collection
  # to streamline later [off-session payments](https://docs.epayments.network/payments/setup-intents).
  # If you use the SetupIntent with a [Customer](https://docs.epayments.network/api#setup_intent_object-customer),
